...
async function handleFHIRRequest(request, env, _ctx) {
...
async function handleNPHIESRequest(request, env, _ctx) {
...
async function cacheMaintenanceTask(_env) {
...
async function handleDatabaseRequest(request, _env, _ctx) {
    const url = new URL(request.url);
